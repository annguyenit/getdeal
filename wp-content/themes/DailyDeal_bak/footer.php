...
<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('footer_above')){?>
 ...
 <?php templ_before_footer(); // content end hooks?>
	...
	<div id="copyright"> &copy GetDeals.nl | Dagaanbiedingen in Amsterdam, Rotterdam, Utrecht, Eindhoven, Maastricht en de rest van Nederland</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A HREF="http://www.getdeals.nl/contact-getdeals/">Contact</A></div>
