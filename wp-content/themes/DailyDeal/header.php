...
<script>
  ...
  ga('create', 'UA-17978782-2', 'auto');
  ga('send', 'pageview');
  ga('create', 'UA-53295142-1',{'name': 'overview'});
  ga('overview.send', 'pageview');
		...
		<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('header_above')){?>
		 <?php } else {?>  <?php }?>
          <?php if(strtolower(get_option('pttthemes_submit_deal_link'))!='disable'){ ?>
			...
			<?php if(!is_user_logged_in() && get_option('ptthemes_enable_fb_twtr_icon') == 'Yes'){?>
				<div class="mp_social_connect_form">
					<ul>
						<li><a class="facebook" href="<?php echo get_option('ptthemes_fb_url'); ?>" title='Facebook Page' target='_blank'/>FB</a></li>
						<li><a class="twitter" href="<?php echo get_option('ptthemes_twtr_url'); ?>" title='Twitter Page' target='_blank'/>TW</a></li>
					</ul>
				</div>';
			<?php }?> 
...
}else 
{
		...
		<?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('header_above')){?>
		 <?php } else {?>  <?php }?>	  
 		 <?php if(strtolower(get_option('pttthemes_submit_deal_link'))!='disable'){ ?>
			...
			<?php if(get_option('ptthemes_enable_fb_twtr_icon') == 'Yes'){?>
				<div class="mp_social_connect_form">
					<ul>
						<li><a class="facebook" href="<?php echo get_option('ptthemes_fb_url'); ?>" title='Facebook Page' target='_blank'/>FB</a></li>
						<li><a class="twitter" href="<?php echo get_option('ptthemes_twtr_url'); ?>" title='Twitter Page' target='_blank'/>TW</a></li>
 ...
 <div  class="inner" > 
    ...
    <div id="container" class="clear">
   <?php 
		if($_GET['ptype'] != 'dealform' && $_GET['ptype'] != 'deals' && $_GET['ptype'] != 'profile' && $_GET['ptype'] != 'login' && $_GET['ptype'] != 'taxonomy_alle_deals_tab' && $_GET['ptype'] != 'taxonomy_live_deal_tab' && $_GET['ptype'] != 'taxonomy_verlopen_deals_tab' && $_GET['ptype'] != 'buydeal'){
