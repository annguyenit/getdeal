...
$nav_menu_arg = array();
$nav_menu_arg['primary'] = __( 'Top Header Navigation', 'templatic' );
//$nav_menu_arg['secondary'] = __( 'Main Navigation', 'templatic' );
...
if(file_exists(TEMPLATEPATH . '/ecommerce/'))
	define('TT_MODULES_FOLDER_PATH',TEMPLATEPATH.'/dailydealnew/'); //addons folder path
