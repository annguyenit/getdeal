...
function show_image_uploader() {
	...
	// Button Settings
	button_image_url : "<?php echo bloginfo('template_url'); ?>/library/js/swfupload/b_upload.png",
...
/* ]]> */
	...
	if($thumb_img_arr)
	{
        ...
        <div class="imageBox" id="div_<?php echo $thumb_img_arr[$i]['id'];?>">
            ...
            <div class="imageBox_label"><span><a href="javascript:void(0);" id="a_photo_<?php echo $thumb_img_arr[$i]['id'];?>" onClick="javascript:removePhoto(<?php echo $thumb_img_arr[$i]['id'];?>,'');"><img src="<?php echo bloginfo('template_url'); ?>/images/no_image.png" class="img_delete" alt="" ></a></span></div>
		</div>
		<?php
		}
	}
