		...
		<div class="subscribe_box">
				...
				<div class="subscribe_bg">
					 <div class="subscribe_form"> 
						<form action="http://getdeals.us6.list-manage.com/subscribe/post?u=719843f1ee5eed4bffa5d6af7&amp;id=40792a7ef3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
							<input class="text_bg" name="EMAIL" id="eemail_txt_email" value="<?php _e('E-mail adres','templatic')?>" onfocus="if (this.value == '<?php _e('E-mail adres')?>') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php _e('E-mail adres','templatic')?>';}"  maxlength="150" type="text"/>	
							<input class="subscribe_submit" name="subscribe" id="eemail_txt_Button" value="Schrijf je in!" type="submit">				
						</form>
					</div>
