...
//global vars
...

	{
...

		{
			...
			to_nameInfo.text("Vul alsjeblieft een naam in");
...

	{
...

		{
			...
			to_emailInfo.text("Vul alsjeblieft een geldig e-mail adres in");
...

	{
...

		{
			...
			yournameInfo.text("Vul alsjeblieft jouw naam in");
...

	{
...

		{
			...
			youremailInfo.text("Vul alsjeblieft jouw e-mail adres in");
