...
<input type="hidden" name="sendact" value="email_frnd" />
	<h3><?php echo SEND_TO_FRIEND;?></h3>
			...
			<div class="row  clearfix" ><label><?php echo SUBJECT;?> : <span>*</span></label> <input name="frnd_subject" value="<?php echo __('Over.. ');?>" id="frnd_subject" type="text" onblur="if (this.value == '') {this.value = 'Over.. ';}" onfocus="if (this.value == 'Over.. ') {this.value = '';}" /></div>
		

			<div class="row textarea_row  clearfix" ><label><?php echo COMMENTS;?> : <span>*</span></label> <textarea name="frnd_comments" id="frnd_comments" cols="10" rows="5"  onblur="if (this.value == '') {this.value = '<?php echo SEND_DESC; ?>';}" onfocus="if (this.value == '<?php echo SEND_DESC; ?>') {this.value = '';}"  ><?php echo SEND_DESC; ?></textarea></div>
