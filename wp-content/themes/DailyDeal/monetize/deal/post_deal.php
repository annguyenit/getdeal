					...
					{ ?>
							...
							<?php if(get_option(ptttheme_google_map_opt) == 'Enable' && get_option('pttheme_google_map_api') != '') {  ?>
							 ...
							 <?php } ?>
								...
								<div class="category_list clearfix">
									...
									$query12 = ("SELECT * FROM $tmtable,$wpdb->terms WHERE $tmtable.term_id = $ttable.term_id and $tmtable.taxonomy = '".CUSTOM_CATEGORY_TYPE1."'");
                        ...
                        <div class="form_row clearfix">
							...
							<?php 
								...
								<img src="<?php if($_SESSION['deal_image'] !="") { echo templ_thumbimage_filter($_SESSION['deal_image'],168,180); }else{ echo templ_thumbimage_filter($destination_path.get_post_meta($edit_deal->ID,'file_name',true),168,180); } ?>" width="168" height="180" alt="<?php $_SESSION['filename']; ?>" /> <?php } ?>
							...
							<img src="<?php echo templ_thumbimage_filter($destination_path.get_post_meta($edit_deal->ID,'file_name',true),168,180); ?>" width="168" height="180" alt="<?php $edit_deal->post_title; ?>" />
							<?php }
							}else{ ?>
