...
$args = array('numberposts' => 1,'meta_key' =>'is_expired' , 'meta_value' =>'0','post_status' => 'publish','post_type' => CUSTOM_POST_TYPE1,'meta_key' =>'status' , 'meta_value' =>'2' ,'orderby' => 'DESC');
  ...
  <div class=" box_bottom">
    ...
    <div class="content_left"> <a href="<?php the_permalink(); ?>">
      <?php	if(get_post_meta($post->ID,'file_name',true) != "") { 
				...
				?>
      <img src="<?php echo templ_thumbimage_filter($destination_url.get_post_meta($post->ID,'file_name',true),330,250);?>" width="330" height="250" alt="" />
      <?php } else { 
