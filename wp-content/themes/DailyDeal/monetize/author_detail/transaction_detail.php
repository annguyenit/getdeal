<?php 
 if($_SERVER['HTTP_REFERER'] != ''){ 
	...
	$deals_res = $wpdb->get_row("select p.* from $post_db_table_name p where p.ID = '".$_REQUEST['transid']."' and p.post_type = '".CUSTOM_POST_TYPE1."' ");
			...
			<li>
				<div class="posts_deal">							
					...
					if(get_post_meta($deals_res->ID,'file_name',true) != "") { ?>
						<img src="<?php echo templ_thumbimage_filter(get_post_meta($deals_res->ID,'file_name',true),165,180);?>" width="165" height="180" alt=""/>
			  <?php } else { ?>
