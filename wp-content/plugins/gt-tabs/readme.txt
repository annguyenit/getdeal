=== GT Tabs (formerly postTabs) ===
Contributors: Billy Bryant
Donate link: http://www.CustomDesignSite.net/gt-tabs/
Tags: post, page, tabs, content, section, subsection, tab
Requires at least: 2.1
Tested up to: 3.1.2
Stable tag: 3.1

GT Tabs allows you to easily split your post/page content into Tabs that will be shown to your visitors
...
* Replace the files
* Go to Setting > GT Tabs, choose a value to the new options and save it

== Usage ==

Go to Settings > GT Tabs (or Options > GT Tabs) to adjust the colors of your tabs.
...
* migrated abanoned project to "GT Tabs" as version 3.0.  Previous versions of postTabs remain untouched.
